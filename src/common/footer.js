...
const messages = [
  ...
  },
  {
    ...
    I am really confused & would love your thoughts on it.',
      ...
      <List className={Styles.list}>
        {
          messages.map(
            (msg) => {
              ...
              return (
                <Fragment key={id}>
                  {id === 1 && <ListSubheader className={Styles.subHeader}>Today</ListSubheader>}
                  {
                    id === 3
                    && <ListSubheader className={Styles.subHeader}>Yesterday</ListSubheader>
                  }
                  <ListItem button>
                    <Avatar alt="Profile Picture" src={msg.person} />
                    <ListItemText primary={msg.primary} secondary={msg.secondary} />
                  </ListItem>
                </Fragment>
              );
            },
